  ...
  const books = [
    {
      ...
      description:
        "A novel by F. Scott Fitzgerald that captures the excesses of the Jazz Age.",
      price: 19.99,
      category: "Classic",
      createdAt: new Date(),
    },
    ...
    },
    {
      title: "1984",
      description:
        "George Orwell's dystopian novel exploring the dangers of totalitarianism.",
      price: 14.95,
...

    {
      ...
      description:
        "J.D. Salinger's influential novel about teenage angst and rebellion.",
      price: 12.75,
      category: "Fiction",
      createdAt: new Date(),
    },
            ...
            books.map((el) => {
              return (
                <tr key={el.id} className="border border-slate-300 ...">
                  ...
                  <td>
                    <button onClick={() => handleRemoveBook(el._id)}>
                      Delete
                    </button>
                  </td>
                </tr>
